...
ggplot() +
  geom_histogram(aes(x = datos, y = ..density..),
                 bins = 20, fill = "blue", color = "black", alpha = 0.6) +
  geom_line(aes(x = x_seq, y = dens_teorica), color = "red", size = 1.2) +
