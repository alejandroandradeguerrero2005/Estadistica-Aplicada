...
ggplot(medicina_data, aes(x = k, y = probabilidad)) +
  geom_col(fill = "yellow", alpha = 0.7, width = 0.8) +
  geom_vline(xintercept = media_curas, color = "blue", linetype = "dashed", size = 1) +
  geom_vline(xintercept = c(18, 22), color = "red", linetype = "dotted", size = 1) +
...
ggplot(comp_exr_data, aes(x = Valor, fill = Tipo)) +
  ...
  scale_fill_manual(values = c("Simulada" = "purple", "Teórica" = "pink")) +
